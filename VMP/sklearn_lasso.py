...
## R squared 
# really low (11.07, 9.17)
print('R squared training', round(reg.score(X_train, y_train)*100, 2)) # 11.07
print('R squared test set', round(reg.score(X_test, y_test)*100, 2)) # 9.17
## MSE
...
coef_df['index']=coef_df.index
plot_coef(coef_df,
          outname='lasso_coef_time_train_test') 